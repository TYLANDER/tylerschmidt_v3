    ...
    <div className="relative h-screen overflow-hidden bg-black">
      ...
      <div className="relative z-10 flex h-full">
        ...
        <motion.div
          initial={{ x: -300 }}
          animate={{ x: 0 }}
          className="flex h-full w-96 flex-col border-r border-border bg-background/90 backdrop-blur-sm"
        >
          {/* Header */}
          <div className="border-b border-border p-6">
            <h1 className="mb-2 text-2xl font-bold">Conversation Canvas</h1>
                  ...
                  >
                    ...
                    <div className="mt-1 flex items-center gap-2">
                      <span
                        ...
                        style={{
                          backgroundColor: sentimentColors[message.sentiment],
                        }}
                      />
          ...
          <form onSubmit={handleSubmit} className="border-t border-border p-6">
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 rounded-lg bg-muted px-4 py-2 focus:outline-none focus:ring-2 focus:ring-primary"
              />
              <button
                type="submit"
        ...
        <motion.div
          ...
          className="absolute right-6 top-6 flex gap-4"
        >
          <button
            onClick={clearCanvas}
          ...
          {/* Sentiment legend */}
          <div className="flex items-center gap-4 rounded-lg border border-border bg-background/80 px-4 py-2 backdrop-blur-sm">
        ...
        <motion.div
          ...
          animate={{ opacity: 1 }}
          transition={{ delay: 1 }}
          className="absolute bottom-6 right-6 rounded-lg border border-border bg-background/80 px-4 py-2 backdrop-blur-sm"
        >
          <p className="text-xs text-muted-foreground">
            Try different emotions: &quot;I love this!&quot;, &quot;Create
            something beautiful&quot;, &quot;This is frustrating&quot;
          </p>
        </motion.div>
      </div>
      ...
      <motion.div
        ...
        animate={{ opacity: 1 }}
        transition={{ delay: 1 }}
        className="fixed bottom-6 left-1/2 z-50 flex -translate-x-1/2 gap-4"
      >
        <Link
          href="/code-visual"
          className="rounded-lg border border-border bg-background/80 px-4 py-2 text-sm backdrop-blur-sm transition-colors hover:bg-background"
