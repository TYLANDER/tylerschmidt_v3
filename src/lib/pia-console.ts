...
export function initPiaConsole() {
  ...
  window.givePiaTreats = () => {
    console.log(
      "%c🦴 Treats delivered!",
      "color: #ffaa00; font-size: 18px; font-weight: bold;"
    )
    console.log(
      "%c   Pia is happy! (+100 creativity points)",
  ...
  window.addEventListener("keydown", (e) => {
    ...
    if (piaSequence.join("") === "pia") {
      document.body.style.cursor =
        "url(data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMzIiIGhlaWdodD0iMzIiIHZpZXdCb3g9IjAgMCAzMiAzMiIgZmlsbD0ibm9uZSIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj4KPHRleHQgeD0iOCIgeT0iMjQiIGZvbnQtc2l6ZT0iMjQiPvCfkL48L3RleHQ+Cjwvc3ZnPg==), auto"
      console.log(
        "%c🐕 PIA MODE ACTIVATED!",
