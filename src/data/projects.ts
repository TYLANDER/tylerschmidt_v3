...
const projects: Project[] = [
  {
    ...
    oneLiner:
      "Redesigned checkout flow increasing conversion by 23% across global markets.",
  ...
  },
  {
    ...
    oneLiner:
      "Complete digital transformation for 100M+ annual visitors gaming platform.",
  ...
  },
  {
    ...
    oneLiner:
      "Simplified Web3 experience for managing assets across 20+ blockchains.",
  ...
  },
  {
    ...
    oneLiner:
      "Natural language interface making AI accessible to non-technical users.",
  ...
  },
  {
    ...
    oneLiner:
      "Enterprise design system powering 50+ products across multiple platforms.",
