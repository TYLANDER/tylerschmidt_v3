    ...
    return (
      ...
      >
        ...
        {rebellion && isRebelling && (
          <>
            <motion.span
              className="text-danger absolute inset-0 flex items-center justify-center opacity-80"
              initial={{ x: 0 }}
              animate={{ x: [-2, 2, -2, 2, 0] }}
            ...
            <motion.span
              className="text-acid absolute inset-0 flex items-center justify-center opacity-60"
              initial={{ x: 0 }}
              animate={{ x: [2, -2, 2, -2, 0] }}
        ...
        {rebellion && (
          <>
            ...
            />
            <motion.div
              className="absolute bottom-0 right-0 h-2 w-2 border-b-2 border-r-2 border-current"
              animate={
                isRebelling
                  ? {
                      scale: [1, 1.5, 1],
