    ...
    <section className="relative bg-background overflow-hidden">
      <Container className="relative py-24 md:py-32 lg:py-40">
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12 lg:gap-16">
          ...
          >
            <motion.h1 
              className="font-heading text-foreground text-5xl md:text-6xl lg:text-7xl xl:text-8xl leading-[1.1] tracking-tight mb-6"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            <motion.p 
              className="text-foreground/70 text-lg md:text-xl leading-relaxed mb-10 max-w-lg"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
