  ...
  return (
    <section ref={containerRef} className="py-32 md:py-48 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <h2 className="font-heading text-5xl md:text-7xl lg:text-8xl font-bold mb-6">
            Featured Work
          </h2>
          ...
          {sortedProjects.map((project, index) => {
            ...
            return (
              <motion.div
                key={project._id}
                className={`
                  ${isFeatured ? 'md:col-span-7' : index === 1 ? 'md:col-span-5' : 'md:col-span-6'}
                  ${index > 1 ? 'md:mt-16' : ''}
                `}
              ...
              >
                ...
                >
                  <article className="relative">
                    ...
                    {isFeatured && (
                      <motion.div
                        className="absolute top-6 left-6 z-20 bg-blue-500/90 backdrop-blur-sm rounded-full px-4 py-2 text-sm font-medium text-white"
                    ...
                    {/* Project image */}
                    <div className={`
                      relative overflow-hidden rounded-2xl bg-muted mb-6
                      ${isFeatured ? 'aspect-[16/10]' : 'aspect-[4/3]'}
                    `}>
                      <motion.div 
                        className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 z-10"
                      />
                    ...
                    <div className="space-y-3">
                      ...
                      <h3 className={`
                        font-heading font-bold group-hover:text-blue-500 transition-colors duration-300
                    ...
                    <motion.div 
                      ...
                      initial={{ width: 0 }}
                      animate={{ width: hoveredProject === project._id ? '100%' : '0%' }}
                      transition={{ duration: 0.3 }}
                    />
                  </article>
                </Link>
        ...
        >
          <Link 
            href="/work"
            className="inline-flex items-center gap-3 text-xl font-medium text-foreground hover:text-blue-500 transition-colors duration-300 group"
          >
