        ...
        <div className="text-center">
          ...
          >
            ...
            <p className="mb-8 text-xl text-muted-foreground md:text-2xl">
              You&apos;re not alone here. {filteredTrails.length} visitors
              before you.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="mx-auto max-w-md text-sm text-muted-foreground">
              Your movements create the glowing trail. Every visitor leaves
              their mark.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            className="mx-auto mt-12 grid max-w-2xl grid-cols-2 gap-4 md:grid-cols-4"
          >
            {[
              ...
              { label: "Your Trail Length", value: userTrail.length },
              {
                ...
                value: filteredTrails.filter((_, i) => i < 5).length,
              },
