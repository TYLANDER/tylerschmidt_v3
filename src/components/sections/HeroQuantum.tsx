      ...
      <Container className="relative z-10">
        <div className="text-center">
            ...
            {!collapsedState ? (
              ...
              >
                {quantumStates.map((state) => (
                  ...
                  >
                    <div
                      className="relative rounded-2xl border-2 p-8 backdrop-blur-md transition-all duration-300"
                      style={{
                ...
                {(() => {
                  ...
                  return (
                    <div className="mx-auto max-w-2xl">
                      ...
                      <motion.button
                        onClick={handleReset}
                        className="rounded-lg bg-muted px-6 py-3 text-foreground transition-colors hover:bg-muted/80"
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
          ...
          <motion.div
            ...
            transition={{ delay: 1 }}
          >
            <div className="rounded-lg border border-border bg-card/80 px-4 py-2 backdrop-blur-sm">
