...
export function PrecisionPunkHero() {
  ...
  const GridLines = () => (
    <svg className="absolute inset-0 w-full h-full" style={{ zIndex: precisionPunk.layers.ground }}>
      <defs>
        <pattern id="grid" width={precisionPunk.grid.base * 8} height={precisionPunk.grid.base * 8} patternUnits="userSpaceOnUse">
          <path 
            d={`M ${precisionPunk.grid.base * 8} 0 L 0 0 0 ${precisionPunk.grid.base * 8}`} 
            fill="none" 
            stroke="currentColor" 
            strokeWidth="0.5"
  ...
  return (
    ...
    >
          ...
          <div className="relative z-10 text-center px-8">
            ...
            >
              ...
              <motion.h1 
                ...
                style={{ fontSize: precisionPunk.type.display }}
              >
                <motion.span
              ...
              <motion.p 
                ...
                style={{ fontSize: precisionPunk.type.title }}
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
              ...
              >
                ...
                <motion.span 
                  ...
                  animate={isBreaking ? { 
                    color: [precisionPunk.color.voltage, precisionPunk.color.danger, precisionPunk.color.acid],
                  } : {}}
              ...
              <motion.p
                ...
                style={{ fontSize: precisionPunk.type.body }}
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
            ...
            >
              ...
              <motion.a
                ...
                whileHover={{ 
                  borderColor: precisionPunk.color.voltage,
                  color: precisionPunk.color.voltage,
                  x: [0, -2, 2, -2, 2, 0],
                }}
      ...
      <motion.div
        ...
        transition={{
          duration: Number(precisionPunk.motion.pulse) / 1000,
          repeat: Infinity,
          ease: [0.37, 0, 0.63, 1],
        }}
      >
