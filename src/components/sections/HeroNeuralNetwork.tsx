...
const nodes: Node[] = [
  ...
  },
  {
    ...
    connections: ["frontend", "backend", "systems"],
    activation: 0,
  },
  {
    id: "creative",
    ...
    category: "skill",
    position: new THREE.Vector3(-3, 0, 0),
    connections: ["art", "motion", "interaction"],
    activation: 0,
  },
  ...
  },
  {
    ...
    connections: ["project2", "interaction"],
    activation: 0,
  },
  {
    id: "frontend",
    ...
    connections: ["react", "typescript", "project1"],
    activation: 0,
  },
  {
    id: "backend",
    ...
    connections: ["node", "database", "project3"],
    activation: 0,
  },
  ...
  // Projects
  {
    ...
    category: "project",
    position: new THREE.Vector3(1.5, 6, 0),
    connections: [],
    activation: 0,
  },
  {
  ...
  },
  {
    ...
    category: "project",
    position: new THREE.Vector3(4.5, 6, 0),
    connections: [],
    activation: 0,
  },
  {
...
function NeuralNetworkScene() {
  ...
  const [thoughts, setThoughts] = useState<
    Array<{ id: string; from: Node; to: Node }>
  >([])
    ...
    const interval = setInterval(() => {
      ...
      if (randomNode.connections.length > 0) {
        ...
        if (targetNode) {
          ...
          setThoughts((prev) => [
            ...prev,
            { id: thoughtId, from: randomNode, to: targetNode },
          ])
          ...
          setNetworkNodes((prev) =>
            prev.map((n) => ({
              ...n,
              activation:
                n.id === randomNode.id || n.id === targetId
                  ? 1
                  : n.activation * 0.95,
            }))
          )
          ...
          onHover={(n) => {
            ...
            setNetworkNodes((prev) =>
              prev.map((node) => ({
                ...node,
                activation:
                  n.connections.includes(node.id) || node.id === n.id
                    ? 1
                    : node.activation,
              }))
            )
