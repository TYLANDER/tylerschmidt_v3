    ...
    >
      ...
      >
        ...
        >
          <motion.a
            href="#work"
            className="hover-lift group relative overflow-hidden rounded-lg bg-primary px-8 py-4 font-medium text-primary-foreground"
          ...
          <motion.a
            href="#contact"
            className="rounded-lg border-2 border-border px-8 py-4 font-medium text-foreground transition-colors duration-300 hover:border-accent"
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
          >
            Get in Touch
