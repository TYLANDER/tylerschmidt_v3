...
export function HeroParticleTypography() {
  ...
  return (
    <section className="relative h-screen overflow-hidden">
      ...
      <Container className="pointer-events-none relative z-10 flex h-full items-end pb-20">
        <div className="w-full">
          ...
          >
            <button
              ...
              className="pointer-events-auto rounded-full bg-black px-4 py-2 font-medium text-white transition-opacity hover:opacity-80 dark:bg-white dark:text-black"
              disabled={isExploded}
            >
