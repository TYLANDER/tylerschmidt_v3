  ...
  return (
    <section className="bg-white py-20 md:py-24">
      <Container>
        ...
        >
          <h2 className="font-heading text-4xl md:text-5xl lg:text-6xl text-ink mb-4">
            Selected Work
          </h2>
          ...
          {items.map((project, index) => (
            ...
            >
              <Link href={`/work/${project.slug}`} className="group block">
                <article className="relative bg-white rounded-lg overflow-hidden transition-all duration-300 hover:shadow-xl">
